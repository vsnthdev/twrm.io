...
export const Footer = (): ReactElement => {
    return <footer className="bg-white -mt-10 flex flex-col items-center py-10 text-center">
        <div className="container flex flex-col items-center space-y-10">
            <div className="w-full flex">
                <hr className="border-0 mx-10 w-full h-1 bg-slate-200 rounded-full md:mx-20" />
            </div>
            <div className="flex flex-col items-center">
                <Logo/>
                <p className="mt-5 text-slate-600">Made with 💖 by <a href="https://vsnth.dev" className="text-slate-500 dark:text-white" target="_blank" rel="noopener">Vasanth Srivatsa</a>.</p>
